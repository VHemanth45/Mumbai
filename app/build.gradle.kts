...
android {
    namespace = "com.citymemory"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.citymemory"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Compose UI tests run on Robolectric rather than a device, so the whole
    // suite stays runnable with `gradlew test` and no emulator.
